...
@WebServlet("/ServletAtrativo")
public class ServletAtrativo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ServletAtrativo() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println("<head> <tittle> Inclusão de Atrativos </tittle></head>");
		out.println("<body>");
		...
		try {
			...
			String retorno = atrativos.atualizar(AtrativoDAO.INCLUSAO);
			atrativos.bd.close();
